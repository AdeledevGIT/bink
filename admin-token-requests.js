...
async function loadTokenRequests() {
    ...
    try {
        ...
        // Apply pagination
        const startIndex = (currentTokenRequestPage - 1) * tokenRequestsPerPage;
        query = query.limit(tokenRequestsPerPage).offset(startIndex);

        // Get requests
        const tokenRequests = await query.get();
        ...
        tokenRequestDetailsContainer.innerHTML = `
            <div class="details-grid">
                ...
                <div class="detail-item">
                    ...
                    <span class="detail-value status-badge ${currentTokenRequest.status}">${currentTokenRequest.status.charAt(0).toUpperCase() + currentTokenRequest.status.slice(1)}</span>
                </div>
                <div class="detail-item">
