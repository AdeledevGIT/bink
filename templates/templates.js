            ...
            <div class="bio-container">
                ...
                <div class="bio-header">
                    <div class="profile-image-container">
                        <img src="${data.profilePicUrl || 'profile.png'}" alt="Profile Image">
                    </div>
            ...
            <div class="neoncard-container">
                ...
                <div class="neoncard-header">
                    <div class="neoncard-avatar-container">
                        <img class="neoncard-avatar" src="${data.profilePicUrl || 'profile.png'}" alt="Profile">
                    </div>
                    <div class="neoncard-username" data-text="${window.BINK.templates.formatUsername(data.username)}">${window.BINK.templates.formatUsername(data.username)}</div>
        ...
        <div class="glass-bio-bg">
            <div class="glass-bio-card">
                ...
                <div class="glass-profile">
                    <img class="glass-avatar" src="${data.profilePicUrl || 'profile.png'}" alt="Profile">
                    <div class="glass-name">${window.BINK.templates.formatUsername(data.username)}</div>
        ...
        <div class="purplecard-bio-bg">
            <div class="purplecard-bio-main">
                ...
                <div class="purplecard-header">
                    <img class="purplecard-avatar" src="${data.profilePicUrl || 'profile.png'}" alt="Profile">
                    <div class="purplecard-username">${window.BINK.templates.formatUsername(data.username)}</div>
            ...
            <div class="landing-banner">
                <div class="landing-profile-row">
                    <div class="landing-profile-pic-username">
                        <img class="landing-profile-pic" src="${data.profilePicUrl || 'profile.png'}" alt="Profile">
                        <div class="landing-username-inline">${window.BINK.templates.formatUsername(data.username)}</div>
                    </div>
                </div>
            </div>
            <div class="landing-main">
                <div class="landing-section-title">ABOUT ${data.username ? window.BINK.templates.formatUsername(data.username) : ''}</div>
            ...
            <div class="blacklanding-banner">
                <div class="blacklanding-profile-row-inline">
                    <div class="blacklanding-profile-pic-username">
                        <img class="blacklanding-profile-pic" src="${data.profilePicUrl || 'profile.png'}" alt="Profile">
                        <div class="blacklanding-username-inline">${window.BINK.templates.formatUsername(data.username)}</div>
                    </div>
                </div>
            </div>
            <div class="blacklanding-main">
                <div class="blacklanding-about-section">
                    <div class="blacklanding-section-title">ABOUT ${data.username ? window.BINK.templates.formatUsername(data.username) : ''}</div>
                ...
                <div class="gradientflow-card">
                    ...
                    <div class="gradientflow-profile">
                        <div class="gradientflow-avatar-container">
                            <img class="gradientflow-avatar" src="${data.profilePicUrl || 'profile.png'}" alt="Profile">
                        </div>
                        <div class="gradientflow-username">${window.BINK.templates.formatUsername(data.username)}</div>
                ...
                <div class="darkelegance-card">
                    ...
                    <div class="darkelegance-profile">
                        <div class="darkelegance-avatar-container">
                            <img class="darkelegance-avatar" src="${data.profilePicUrl || 'profile.png'}" alt="Profile">
                        </div>
                        <div class="darkelegance-username">${window.BINK.templates.formatUsername(data.username)}</div>
                ...
                <div class="neonglow-card">
                    ...
                    <div class="neonglow-profile">
                        <div class="neonglow-avatar-container">
                            <img class="neonglow-avatar" src="${data.profilePicUrl || 'profile.png'}" alt="Profile">
                        </div>
                        <div class="neonglow-username">${window.BINK.templates.formatUsername(data.username)}</div>
                ...
                <div class="minimalzen-card">
                    ...
                    <div class="minimalzen-profile">
                        <div class="minimalzen-avatar-container">
                            <img class="minimalzen-avatar" src="${data.profilePicUrl || 'profile.png'}" alt="Profile">
                        </div>
                        <div class="minimalzen-username">${window.BINK.templates.formatUsername(data.username)}</div>
                ...
                <div class="techwave-card">
                    ...
                    <div class="techwave-profile">
                        <div class="techwave-avatar-container">
                            <img class="techwave-avatar" src="${data.profilePicUrl || 'profile.png'}" alt="Profile">
                        </div>
                        <div class="techwave-username">${window.BINK.templates.formatUsername(data.username)}</div>
                ...
                <div class="splitscreen-sidebar">
                    <div class="splitscreen-profile">
                        <div class="splitscreen-avatar-container">
                            <img class="splitscreen-avatar" src="${data.profilePicUrl || 'profile.png'}" alt="Profile">
                        </div>
                        <div class="splitscreen-username">${window.BINK.templates.formatUsername(data.username)}</div>
                ...
                <div class="magazine-profile-section">
                    <div class="magazine-profile-header">
                        <div class="magazine-avatar-container">
                            <img class="magazine-avatar" src="${data.profilePicUrl || 'profile.png'}" alt="Profile">
                        </div>
                        <div class="magazine-profile-info">
                            <div class="magazine-username">${window.BINK.templates.formatUsername(data.username)}</div>
                ...
                <div class="retrowave-card">
                    ...
                    <div class="retrowave-profile">
                        <div class="retrowave-avatar-container">
                            <img class="retrowave-avatar" src="${data.profilePicUrl || 'profile.png'}" alt="Profile">
                        </div>
                        <div class="retrowave-username">${window.BINK.templates.formatUsername(data.username)}</div>
                ...
                <div class="nature-card">
                    ...
                    <div class="nature-profile">
                        <div class="nature-avatar-container">
                            <img class="nature-avatar" src="${data.profilePicUrl || 'profile.png'}" alt="Profile">
                        </div>
                        <div class="nature-username">@${data.username}</div>
            ...
            <div class="portfolio-container">
                ...
                <div class="portfolio-profile-section">
                    <div class="portfolio-avatar-container">
                        <img class="portfolio-avatar" src="${data.profilePicUrl || 'profile.png'}" alt="Profile">
                    </div>
                    <div class="portfolio-profile-info">
                        <div class="portfolio-username">@${data.username}</div>
